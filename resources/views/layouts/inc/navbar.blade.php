    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                ...
                <li><a href="#" class="dropdown-item">Kiev: {{ now()->timezone(config('app.timezone_client')) }}</a></li>
                @endif
            </ul>
        </li>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="/vendor/adminlte/dist/img/user2-160x160.jpg" class="user-image img-circle elevation-2" alt="User Image">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-footer">
            ...
            <a href="/logout" class="btn btn-default btn-flat float-right js-action-send" data-confirm="Logout?" >Sign out</a>
          </li>
        </ul>
      </li>
        @endauth
      ...
      <li class="nav-item">
        <a href="/logout" class="nav-link js-action-send" data-confirm="Logout?"  role="button">
